...
?>
    <div class="group">
    <br> <input type="text" name="ReminderName" required><br><br>
			<span class="highlight"></span>
			<span class="bar"></span>
			<label>Name</label>
			</div>
      <div class="group">
    <br> <input type="text" name="ReminderDescription" required><br><br>
			<span class="highlight"></span>
			<span class="bar"></span>
			<label>Description</label>
			</div>
      <div class="group">
      <br><input type="datetime-local" id="datefield" min='2020-11-11' name="ReminderTime"><br><br>
			<span class="highlight"></span>
