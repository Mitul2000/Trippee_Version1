...
<div id="content" class="p-4 p-md-5 pt-5">
  <div class = "container">
    ...
    echo '<input type="text" name="destination" required>';
    echo '<span class="highlight"></span>';
    echo '<span class="bar"></span>';
    echo '<label>Destination</label>';
    echo '</div>';
    echo '<div class="group">';
    echo '<input type="number" name="priority" min="1" required>';
    echo '<span class="highlight"></span>';
    echo '<span class="bar"></span>';
    echo '<label>Priority</label>';
    echo '</div>';
    echo '<button type="submit" class="btn btn-secondary">Add Destination</button>';
    echo '</form>';
    ?>
...
<script>
    ...
    function removeseat(seatid,pname) {
        ...
        document.getElementById(seatid).elements[5].style.display="none";
...
<?php
    ...
    if ($num <= 2){
        ...
        for($i = 1; $i <= $num; $i++){
            ...
            echo '<button type="submit" class="btn btn-secondary">Select Seat</button>';
            echo '</form>';
            echo '</td>';
        }
        echo '</tr>'; 
...
<?php
  $passengers = $mysqli -> query("SELECT * FROM passenger_occupancy WHERE objectid='$objectid'");
